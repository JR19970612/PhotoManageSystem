...
CREATE TABLE `photo`  (
  ...
  `photo_original_url` char(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `photo_thum_url` char(60) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
